// Auto-generated from index-2.html section 9
const HomeSection9 = () => (
  ...
  <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop" alt="Image" />
  ...
  <div className="main-testimonial-item">
  <img src="https://images.unsplash.com/photo-1502685457733-3b37ad9d18d0?w=150&h=150&fit=crop" alt="Image" />
  <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less this fsat normal distribution of to using 'Content here,</p>
  <h3>Adam Dew</h3>
  <span>Founder</span>
  <ul>
