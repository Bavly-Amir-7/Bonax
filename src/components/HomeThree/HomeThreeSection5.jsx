// Auto-generated from index-3.html section 5
const HomeThreeSection5 = () => (
  ...
  <span className="up-title">FAQ</span>
  <h2>We Have 37+ Years Of Experience Helped Success</h2>
  </div>
  </div>
  <div className="col-lg-6 wow fadeInRight delay-0-2s">
  <p className="p-style">Louasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam.</p>
  </div>
  </div>
  </div>
